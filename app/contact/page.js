...
const ContactUs = () => {
    ...
    const formSubmit = async (e) => {
        ...
        const data = { email, phoneNo, message };
    ...
    if (isSignedIn) {
            ...
            <>
                <div className="flex justify-center gap-10 flex-wrap-reverse items-center">
                    <div className="box flex flex-col w-auto gap-10">
                        ...
                        <iframe
                            className="max-md:w-[300px] max-md:h-[450px] max-md:mb-10"
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3752.3576829868753!2d75.31685987399237!3d19.867112926663502!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bdb9867668e59d1%3A0x3e00720a165fcb9b!2sSwastik%20Pathology%20Lab!5e0!3m2!1sen!2sin!4v1734020359846!5m2!1sen!2sin"
                            width="600"
                            height="450"
                            allowFullScreen=""
                            loading="lazy"
                            ...
                            <div className="py-8 px-4 max-w-screen-md">
                                ...
                                <form onSubmit={formSubmit} className="space-y-8">
                                    ...
                                    <div className="sm:col-span-2">
                                        <label htmlFor="message" className="block mb-2 text-sm font-medium bg-white text-[#5A9BD5]">
                                            Message
                                        </label>
                                        <textarea
                                            id="message"
                                    ...
                                    <button
                                        type="submit"
                                        className="py-3 px-5 text-sm font-medium text-center text-white rounded-lg bg-blue-600 hover:bg-[#132445] transition-all duration-200 sm:w-fit"
                                    >
                                        Send Message
                                    </button>
                                </form>
        ...
        return (
            <div>
                <h1 className="text-black text-3xl min-h-screen text-center">
